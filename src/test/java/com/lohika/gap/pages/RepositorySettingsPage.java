...
public class RepositorySettingsPage extends BasePage {
    ...
    @FindBy(xpath = "//button[@type and contains(text(), 'Delete this repository')]") private WebElement removeRepositoryButton;
    @FindBy(id = "rename_field") private WebElement rename_field;
    @FindBy(css = "button.btn.js-rename-repository-button") private WebElement rename_button;
    @FindBy(xpath = "//*[@id='facebox']/div/div/form/p/input") private WebElement confirmation_field;
    @FindBy(xpath = ".//*[@id='facebox']/div/div/form/button") private WebElement confirmButton;
