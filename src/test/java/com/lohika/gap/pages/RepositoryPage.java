...
public class RepositoryPage extends BasePage {
    ...
    private WebElement repoSettingsLink;
    ...
    @FindBy(css = "div.no-results.blankslate.blankslate-clean-background")
    private WebElement searchStatus;
    @FindBy(linkText = "Upload files")
    private WebElement uploadFilesButton;
    @FindBy(xpath = "//input[@type='file']")
    private WebElement upload;
    @FindBy(css = "tbody.js-manifest-file-list-root")
    private WebElement uploadedFile;
    @FindBy(css = "button.btn.btn-primary.js-blob-submit")
    private WebElement submitUpload;
    @FindBy(xpath = "//span[@class='edit-link']/button[@type='button']")
    private WebElement editDescriptionButton;
    @FindBy(id = "repo_description")
    private WebElement editRepoDescriptionField;
    @FindBy(id = "repo_homepage")
    private WebElement editRepoHomepageField;
    @FindBy(xpath = "//button[@type='submit' and contains(text(),'Save')]")
    private WebElement saveDescriptionButton;
    @FindBy(css = "button.btn-link.js-details-target")
    private WebElement cancelDescriptionButton;
    @FindBy(css = "em.d-block.text-gray")
    private WebElement noDescriptionText;
    @FindBy(css = "span.col-11.text-gray-dark.mr-2")
    ...
    public void uploadFile(String fileName) {
        ...
        insertTextToElement(path + File.separator + fileName, upload);
        Wait.seconds(1);
