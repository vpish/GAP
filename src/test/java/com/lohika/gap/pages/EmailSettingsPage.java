...
public class EmailSettingsPage extends BasePage {
    ...
    @FindBy(id = "type_marketing")
    private WebElement typeMarketingRadiobutton;
    @FindBy(id = "type_transactional")
    private WebElement typeTransactionalRadiobutton;
    @FindBy(css = "input.btn.js-email-global-unsubscribe-submit")
    private WebElement SaveEmailPreferencesButton;
    @FindBy(xpath = "//span[@title='new_mail@gmail.com']/following-sibling::span[2]/form/button")
